...
ActiveRecord::Schema.define(version: 2020_04_19_150456) do
  ...
  create_table "movements", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.uuid "hot_spot_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["hot_spot_id"], name: "index_movements_on_hot_spot_id"
  ...
  add_foreign_key "movements", "hot_spots"
